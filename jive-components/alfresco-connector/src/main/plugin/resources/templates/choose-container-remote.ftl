...
<header class="j-page-header">        
         <h2>${title?html}<span><@s.text name="global.colon"/> <@s.text name="container.choose.location.remote"/></span></h2>        
</header>
<!-- END header & intro -->
    ...
    <div id="jive-body-maincol-container">
        <div id="jive-body-maincol">
            ...
            <div class="j-box j-enhanced jive-box-form jive-standard-formblock-container">
                    ...
                    <form action="<@s.url action='choose-container-remote'/>" id="choosejivecontainerform" name="jivechoosecontainerform" class="j-form">                        
                        ...
                        <input type="hidden" name="remoteContainer" id="jive-remote-container-id"/>
